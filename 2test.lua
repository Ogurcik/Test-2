...
teleportTab.Parent = b
teleportTab.BackgroundColor3 = Color3.fromRGB(50, 50, 50)
teleportTab.Position = UDim2.new(0.1, 0, 0.6, 0)
teleportTab.Size = UDim2.new(0.8, 0, 0, 150)
teleportTab.Visible = false
teleportTab.BorderSizePixel = 0
i:Clone().Parent = teleportTab

local teleportButton = createButton(b, UDim2.new(0.5, -50, 0.8, 0), UDim2.new(0, 100, 0, 30), "Teleport", Color3.fromRGB(80, 80, 80), Color3.fromRGB(255, 255, 255))

teleportButton.MouseButton1Click:Connect(function()
    teleportTab.Visible = not teleportTab.Visible
end)

local corBaseButton = createButton(teleportTab, UDim2.new(0.5, -50, 0, 20), UDim2.new(0, 100, 0, 30), "Cor Base", Color3.fromRGB(80, 80, 80), Color3.fromRGB(255, 255, 255))
local exitButton = createButton(teleportTab, UDim2.new(0.5, -50, 0, 60), UDim2.new(0, 100, 0, 30), "Exit", Color3.fromRGB(80, 80, 80), Color3.fromRGB(255, 255, 255))
local fClassButton = createButton(teleportTab, UDim2.new(0.5, -50, 0, 100), UDim2.new(0, 100, 0, 30), "F Class", Color3.fromRGB(80, 80, 80), Color3.fromRGB(255, 255, 255))

corBaseButton.MouseButton1Click:Connect(function()
    LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(521.93, 18.27, -1568.95)
end)
exitButton.MouseButton1Click:Connect(function()
    LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-87.35, -22.54, 756.22)
end)

fClassButton.MouseButton1Click:Connect(function()
    LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-1195.43, -22.46, 403.90)
end)