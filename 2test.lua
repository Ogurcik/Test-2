...
local corArmorButton = createButton(b, UDim2.new(0.1, 0, 0.8, 10), UDim2.new(0.35, -10, 0, 40), "CorArmor", Color3.fromRGB(80, 80, 80), Color3.fromRGB(255, 255, 255))
local radioSpamButton = createButton(b, UDim2.new(0.55, 10, 0.8, 10), UDim2.new(0.35, -10, 0, 40), "RadioSpam", Color3.fromRGB(80, 80, 80), Color3.fromRGB(255, 255, 255))
local aimEspButton = createButton(b, UDim2.new(0.1, 0, 0.9, 20), UDim2.new(0.8, 0, 0, 40), "Aim&Esp", Color3.fromRGB(80, 80, 80), Color3.fromRGB(255, 255, 255))
